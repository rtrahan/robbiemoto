...
export const metadata = {
  title: 'About - Robbiemoto',
  description: 'Learn about Robbiemoto handcrafted ceramics and accessories',
}
      ...
      <main className="pt-16">
        <div className="container px-4 py-20 md:px-8 max-w-4xl mx-auto">
          ...
          <div className="mt-16 text-center space-y-4">
            <h3 className="text-2xl font-serif font-light">Stay Connected</h3>
            <p className="text-gray-600">Follow us for updates on new drops and auction announcements</p>
            <div className="flex gap-4 justify-center pt-4">
              <a 
                href="https://instagram.com/robbiemoto" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 border-2 border-gray-900 text-gray-900 px-8 py-3 rounded-lg font-medium hover:bg-gray-900 hover:text-white transition-all"
              >
