      ...
      <main className={auction?.status === 'live' ? 'pt-28' : 'pt-16'}>
        {auction ? (
          auction.status === 'live' ? (
            ...
            // ENDED - Elegant completed auction display
            <div className="container px-4 py-20 md:px-8">
              <div className="max-w-3xl mx-auto text-center space-y-8">
                {/* Ended Badge */}
                <div>
                  <span className="inline-block px-6 py-2 bg-gray-100 text-gray-600 rounded-full text-xs font-medium uppercase tracking-[0.25em]">
                    This Drop Has Ended
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  <h1 className="text-6xl md:text-7xl font-serif font-light text-gray-900 leading-tight">
                    {auction.name}
                  </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  <a
                    ...
                    className="group inline-flex items-center justify-center gap-3 bg-gray-900 text-white px-12 py-5 rounded-lg font-medium text-lg hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl"
                  >
                    <span>View What Sold</span>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center justify-center gap-3 border-2 border-gray-300 text-gray-700 px-12 py-5 rounded-lg font-medium text-lg hover:border-gray-900 hover:bg-gray-50 transition-all"
                  >
